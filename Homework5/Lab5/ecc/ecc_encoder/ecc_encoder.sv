...
#(parameter M = 8, // Input message data width
 ...
 function logic[N:0] generate_data_with_ecc(logic[M-1:0] din);
  begin
	...
	for(int e_idx=1;     ) begin // for loop line needs to be completed by student
    ...
    for (int i=0;.....) begin // student to complete this line
      // Student to add code here  
    end
    ...
    assign // sutudent to complete this code
	...
	generate_data_with_ecc = //student to add code here
